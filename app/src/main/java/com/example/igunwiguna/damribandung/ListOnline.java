...
import com.example.igunwiguna.damribandung.Model.User;
...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final int PLAY__SERVICES_RES_REQUEST=7172;
    ...
    // Set toolbar and layout/ join menu
        ...
        toolbar.setTitle("Tracking Bus DAMRI");
    ...
    //Firebase
        ...
        setupSystem();
//        Setelah di setup sistem, maka harus me load semua user dari counterReff dan tampilan pada RecycleView
//        Dibawah ini merupakan Online List
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                GooglePlayServicesUtil.getErrorDialog(resultCode,this,PLAY__SERVICES_RES_REQUEST).show();
            }
            else
            {
